...
cd $CODE
wget http://stash.ci-connect.net/spt/public/ndhuang/spt3g.tgz
# And set it up
tar xf spt3g.tgz
...
# Do things?
run="python $STARTDIR/sourcemaps_perbolo_withpointing.py -r .2 -x 1 -y 1 $LOCAL_PATH -o $OUTPUT/singbolo_maps.g3"
echo "Doing $run"
$run
echo ""
