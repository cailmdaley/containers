...
mem = '32G'
logname = 'lrnoise_map'
exec = '/home/ndhuang/spt_code/spt3g_software/scratch/ndhuang/condor_stuff/lrnoise/run_map.sh'
...
for id in obsids:
    ...
    substr = sub.format(exec = exec,
                        args = args,
                        inputfiles = '/home/ndhuang/spt_code/spt3g_software/scratch/ndhuang/make_LorR_maps.py',
                        outputfiles = '', 
                        extras = extras,
                        outlog = outlog,
                        errorlog = errorlog,
