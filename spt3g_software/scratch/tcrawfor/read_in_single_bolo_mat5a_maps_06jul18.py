...
file1 = '/spt/user/production/calibration/MAT5A-pixelraster/maps/'+obsid+'.g3'
...
cframe = (core.G3File('/spt/user/production/calibration/calframe/MAT5A-pixelraster/'+obsid+'.g3')).next()
