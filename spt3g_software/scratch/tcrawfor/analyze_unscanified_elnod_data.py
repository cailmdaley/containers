...
# Usage: analyze_unscanified_elnod_data.py -o output.pkl <input files>
#
# (input files should be raw dfmux data files for times that bracket
# el nod)
...
if os.path.exists(args.output):
    raise ValueError('File ' + args.output + ' exists. Quitting.')

#print('Input files are: ' + args.input + '\n')
...
pickle.dump(elnod_dir,open(args.output,'w'))
