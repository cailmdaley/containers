...
#                    weights_dict[field][thiskey].append(np.nanmean(np.asarray(frame['Wunpol'].TT)[ymin:ymax,xmin:xmax]))
#                    mm.RemoveWeightModule(frame)
#                    rms_dict[field][thiskey].append(np.nanstd(np.asarray(frame['T'])[ymin:ymax,xmin:xmax]))
