...
obsid_str = '31999763'
obstime = std_processing.obsid_to_g3time(obsid_str)
file2 = '/spt/data/bolodata/downsampled/mars-pixelraster/'+obsid_str+'/nominal_online_cal.g3'
...
file3 = '/spt/data/bolodata/downsampled/mars-pixelraster/'+obsid_str+'/0000.g3'
...
mapdict = {}
cmapdict = {}
file1 = '/spt/user/production/calibration/mars-pixelraster/maps/'+obsid_str+'.g3'
...
netdict, w_per_k, wndict, wsdict = \
    tctools.quick_nets_from_planet(mapdict,noisedict,banddict,'mars',obstime.mjd,
                                  invert_map=True,reso_arcmin=reso_arcmin,
                                  rate=76.3)
...
for name in netnames:
    opteffdict[name] = w_per_k[name]/wpk_perfect[banddict[name]]
