...
#obsid = '49022482'
obsid = '47635107'
file1 = '/spt/data/bolodata/fullrate/elnod/'+obsid+'/0000.g3'
cfile1 = '/spt/data/bolodata/fullrate/elnod/'+obsid+'/nominal_online_cal.g3'
...
#                    bdict0[name].append(frame['RawTimestreams_Q'][name])
            else:
                for name in names:
                    bdict0[name].append(frame['RawTimestreams_I'][name])
#                    bdict0[name].append(frame['RawTimestreams_Q'][name])
