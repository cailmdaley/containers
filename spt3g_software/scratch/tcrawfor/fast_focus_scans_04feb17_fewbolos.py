...
#bolos2get = ['W158/2017.W158.4.34.6.3360']
bolos2get = pickle.load(open('ggnames_focus_04feb17.pkl'))
...
files1 = glob.glob('/buffer/bolodata/20170203_18*')
files1.sort()
files1 = files1[37:]
files2 = glob.glob('/buffer/bolodata/20170203_19*')
files2.sort()
files2 = files2[0:68]
files = []
for file in files1:
