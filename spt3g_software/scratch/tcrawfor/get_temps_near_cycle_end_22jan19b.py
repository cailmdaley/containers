...
for file1 in arcfiles[0:5]:
    ...
    try:
        ...
        ucstage.append(dtemp['ucstage'][::10])
        icstage.append(dtemp['icstage'][::10])
        uchead.append(dtemp['uchead'][::10])
        ichead.append(dtemp['ichead'][::10])
        ucpump.append(dtemp['ucpump'][::10])
        icpump.append(dtemp['icpump'][::10])
        azs.append(dtemp['az'][::10])
        els.append(dtemp['el'][::10])
        ttimes.append(dtemp['time'][::10])
    except:
