...
files_all=glob.glob('/spt/data/bolodata/fullrate/calibrator/1881*/0000.g3')
files_all.sort()
files = files_all[0:6]
...
for name in names:
    dtemp={}
    dtemp['tau']=tau[name]
    dtemp['dtau']=dtau[name]
    outdict[name]=dtemp

f3=open('/spt/user/tcrawfor/public/taus_18813897.pkl','w')
pickle.dump(outdict,f3)
f3.close()
