...
P.add_argument('input_files', action='store', nargs='+', default=[], help='should be a .pkl file with keys 1 and 2 for the two bundles')
...
group_1 = pickle.load(open(args.input_files[0], "rb"))[1]
group_2 = pickle.load(open(args.input_files[0], "rb"))[2]
