...
#Correct the pointing of the point source map
pipe.Add(mapmaker.CalculatePointing,map_id = 'ps_flatskymap',is_healpix=False, pointing_store_key = 'ps_fsm_key', boresight_ra_key = 'OnlineBoresightRa', boresight_dec_key = 'OnlineBoresightDec')
...
pipe.Add(mapmaker.TodFiltering, ts_in_key='CalTimestreams',
    ...
    poly_order=4, point_source_mask_id = 'ps_flatskymap', point_source_pointing_store_key = 'ps_fsm_key',
