...
from spt3g.util import ExploreFrame
...
pipe.Add(FrameGenerator)
pipe.Add(core.Dump)
pipe.Add(ExploreFrame,
         frame_types=[core.G3FrameType.Scan, core.G3FrameType.Calibration])
