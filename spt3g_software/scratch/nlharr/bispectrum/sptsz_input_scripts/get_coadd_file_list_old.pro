...
function get_coadd_file_list_old, field_name, band
;rlst = '/home/nlharr/Bispec_2500/runlists/runlists_part2_files_nobuffer_20130616newidfmaps/goodfiles_'+strtrim(string(band),2)+'_'+field_name+'.txt'
