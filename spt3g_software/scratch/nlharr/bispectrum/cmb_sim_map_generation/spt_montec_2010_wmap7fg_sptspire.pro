pro spt_montec_2010_wmap7fg_sptspire,freq
...
n=3240 ;x2 = 13824 factors into 2s and 3s

resolution=(0.25/60d0)/180d0*pi
...
;also read in kSZ
    a = read_ascii('~cr/paramfits/cosmomc.r11/ptsrc/dl_ksz_CSFplusPATCHY_13sep2011_norm1_fake25000.txt')
    ksz=ll*0.0
    loff = a.field1[0,0]
...
;tSZ version
    a = read_ascii('~cr/paramfits/cosmomc.r11/ptsrc/dl_shaw_tsz_s10_153ghz_fake25000.txt')
    tsz = ll*0.0
    loff = a.field1[0,0]
...
;stop
openw,5,'/data23/cr/spirespt23h/sims/fhrsim_spirespt_map2010_'+fstr+'_gaussv2.dat'
...
for realization=0,100-1 do begin
