...
alpha_rg = -0.39
dlradio220 = dlradio150 * (219.3/151.7)^(2.*alpha_rg) /dbdt(219.3,151.7)^2
dlradio =[[dlradio150],[sqrt(dlradio150*dlradio220)],[dlradio220]]

czero_ps = 9.5
alpha_dsfg=3.7
dld1 = czero_ps *llfac
dld2 = dld1 * (221.4/154.2)^(2.*alpha_dsfg) /dbdt(221.4,154.2)^2
dldsfg =[[dld1],[sqrt(dld1*dld2)],[dld2]]
;[[llfac0*6.6e-6],[llfac0* 2.24439e-05],[llfac0*7.73299e-05 ]]
...
p220 =  (221.4/154.2)^(2.*alpha_dsfg) /dbdt(221.4,154.2)^2
dlclus220 = dlclus * temp220 * p220
dclus[*,0]=dlclus
...
bmerr=fit_gauss_err(alpha=-1*alpha, /nongauss,ell_in=center)
