pro load_bispec_field_output_hdf5, in_file, bispec, bispec_variance, bispec_weight_used, field_name, bands, grid_bands, bispec_tag, ell_vec, delta_ell
  fid = H5F_OPEN(in_file)
  bispec = simple_load_hdf5( fid,  'bispec')
  bispec_variance = simple_load_hdf5( fid,  'bispec_variance')
  bispec_weight_used = simple_load_hdf5( fid,  'bispec_weight_used')
