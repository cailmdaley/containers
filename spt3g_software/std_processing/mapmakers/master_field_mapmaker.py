...
from spt3g import timestreamflagging, todfilter, coordinateutils, pointing
...
config.add_argument('--notch-by-board', default = False, action = 'store_true')
...
if not args.sim:
    ...
    pointing_ts_key = 'CalTimestreams'
    ...
    m = coordinateutils.fitsio.load_skymap_fits(args.sim_map)
...
if not args.temperature_only and args.add_temperature_only:
    pipe.Add(coordinateutils.map_modules.ConvertPolarizedMapsToT)
